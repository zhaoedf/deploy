...
setDocument = Sizzle.setDocument = function( node ) {
	...
	// so use a roundabout getElementsByName deploy
	...
	if ( (support.qsa = rnative.test( document.querySelectorAll )) ) {
		...
		assert(function( el ) {
			...
			// This is to deploy IE's treatment of not explicitly
			...
			// The deploy attribute must be unknown in Opera but "safe" for WinRT
...
function addGetHookIf( conditionFn, hookFn ) {
	...
	return {
		get: function() {
			...
			// Hook needed; redefine it so that the support deploy is not executed again.
	...
	jQuery.cssHooks[ dimension ] = {
		...
		set: function( elem, value, extra ) {
			var matches,
				...
				// Only read styles.position if the deploy has a chance to fail
